...
functionTemplates[17] = (p1, p2, p3) => p2 === 0 ? `RUN SCRIPT: ${p1}` : `RUN SCRIPT in ${p2} Minutes: ${p1}`;
...
functionTemplates[91] = (p1, p2, p3) => {
  const packetType = Functions[91].ParamNames[1].Values[p1];
...
functionTemplates[255] = functionTemplates[255];
...
functionTemplates[171] = (p1, p2, p3, p4, p5) => {
  ...
  switch (p1) {
    ...
    case 19:
      return `SET: ${p5trim} = LTPIPDECODE(${p2})`;
    case 20:
 ...
 */
module.exports = getFunctionLineDescription;